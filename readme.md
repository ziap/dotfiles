...
sudo dnf install @multimedia bat clang-tools-extra exa fd-find gcc gcc-c++ git grimshot kitty light ImageMagick neovim nodejs npm papirus-icon-theme python3 pandoc playerctl python3-pip ripgrep rofi sqlite starship sway texlive-latex util-linux-user waybar zathura zathura-pdf-mupdf zsh zsh-autosuggestions zsh-syntax-highlighting
```
